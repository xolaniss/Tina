...
combined_climate_data_tbl <-
  ...
  drop_na() |> # dropping missing countries
  filter(!country %in% c("Z01", "Z02", "Z03", "Z04", "Z05", "Z06", "Z07", "Z08", "Z09")) ## Removing Z01 to Z07 countries- I do not know where these come from
